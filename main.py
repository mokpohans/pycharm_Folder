...
global cli, sshcmdline, cmd, sshcmd
...
PW = tk.StringVar()
PW_entry = ttk.Entry(user_frame, textvariable=PW)
PW_entry.grid(row=5, column=2, sticky=tk.W)

ttk.Button(win, text='Connect', command=ssh_login(IP, Port, ID, PW)).grid(row=6, column=0, sticky=tk.E)
